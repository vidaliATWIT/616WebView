...
const MetalButton = styled(({ iconPath, iconSize = '100%', children, ...props }) => {
  return (
    <Button {...props}>
      {iconPath && (
        <img 
          ...
          style={{ 
            width: iconSize, 
            height: iconSize, 
            marginRight: children ? '8px' : '0', // Add spacing if there's text
  ...
  return (
    <Box sx={{}}>
      <MetalSlider
        ...
        sx={{ 
          flexGrow: 1,
          height: '204px' // You'll need to specify a height for vertical sliders
        }}
      />
    ...
    <div className="plugin-window">
      ...
      <div className="plugin-buttons">
        ...
        <div className="button-container1">
          ...
          <svg width="18" height="131" viewBox="0 0 18 131" fill="none" xmlns="http://www.w3.org/2000/svg">
